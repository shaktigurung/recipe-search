...
export default class RecipeDetails extends Component {
  ...
  //   this.state = {
  //     recipe: recipe,
  //     url: `https://www.food2fork.com/api/get?key=bca7c0519705fc57aac4deb4aa8b5e25&rId=${this.props.id}`
  //   }
  // }
  ...
  async componentDidMount() {
    ...
    const url = `https://www.food2fork.com/api/get?key=bca7c0519705fc57aac4deb4aa8b5e25&rId=${id}`;
    try {
